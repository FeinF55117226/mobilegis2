...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady (GoogleMap googleMap) {
        ...
        LatLng untad = new LatLng(-.83643, 119.89369);
        ...
        mMap.addMarker(new MarkerOptions().position(untad).title("Marker in Untad")
                .snippet("Ini adalah Kampus kami").icon(BitmapDescriptorFactory.fromBitmap(markerStart)));
    ...
    private void getCurrentLocation() {
        ...
        location.addOnCompleteListener(new OnCompleteListener() {
            ...
            public void onComplete(@NonNull Task task) {
                ...
                mMap.addMarker(new MarkerOptions().position(new LatLng(currentLocation.getLatitude(), currentLocation.getLongitude())).title("Ini adalah lokasi saya").snippet("Vahriansyah.hs"));
